...
json_file = open('/home/SharedData/Avinandan/DarrellHallucination/streamtwohall.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
streamtwohall = model_from_json(loaded_model_json)
# load weights into new model
streamtwohall.load_weights("/home/SharedData/Avinandan/DarrellHallucination/streamtwohall.hdf5")
...
streamtwohall.compile(optimizer=sgd, loss='categorical_crossentropy',metrics=['accuracy'])

results = streamtwo.evaluate(Xtest_two,Ytest, batch_size=32)
resultshall = streamtwohall.evaluate(Xtest_one,Ytest, batch_size=32)
